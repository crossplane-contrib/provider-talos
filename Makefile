...
XPKGS = provider-talos
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-talos: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Talos CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Talos controllers
...
# This target prepares repo for your provider by replacing all "talos"
